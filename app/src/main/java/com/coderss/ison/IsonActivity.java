...
public class IsonActivity extends FragmentActivity {

	//SoundSet instance initialized by SoundSetLoader
	static SoundSet soundSet;
	
	//Statics set by LayoutSettings
	static int OFFSET = 0;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (item.getItemId() == R.id.openDock) {
			...
			Intent intent = new Intent(getApplicationContext(), LayoutSettings.class);
	...
	public void setUpComponents() {
		...
		TableLayout buttonTable = (TableLayout)this.findViewById(R.id.buttonTable);
		...
		Spinner j = (Spinner)this.findViewById(R.id.numberOfColumns);
		...
		frequency = (TextView)this.findViewById(R.id.textView4);
		setFrequencyText();
	}
